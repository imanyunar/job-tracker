<template>
  <div class="bg-[#F3F4F0] border border-[#C8D0CC] rounded-lg h-full flex flex-col overflow-hidden relative">
    <!-- Loading Detail Skeleton -->
    <div v-if="loading" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 animate-pulse">
      <div class="border-b border-[#C8D0CC] pb-5 space-y-3">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-3.5">
        <div class="bg-[#ECEEEA] rounded-md p-3 border border-[#C8D0CC]/60 space-y-2">
        ...
        <div class="bg-[#ECEEEA] rounded-md p-3 border border-[#C8D0CC]/60 col-span-2 sm:col-span-1 space-y-2">
          <div class="h-3 w-20 rounded skeleton-shimmer"></div>
      ...
      <div class="space-y-2">
        ...
        <div class="h-28 rounded-lg skeleton-shimmer"></div>
      </div>
    </div>
    ...
    <!-- Job Detail View with Smooth Transition -->
    <Transition v-else name="detail-view" mode="out-in">
      <div :key="job.id" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6">
        ...
        <div class="space-y-2">
          ...
          <div class="bg-[#FFFFFF] border border-[#C8D0CC] rounded-lg p-4 max-w-2xl shadow-2xs">
            <p
              v-if="job.notes"
